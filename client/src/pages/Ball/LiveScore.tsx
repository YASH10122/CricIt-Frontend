    ...
    <div className="live-grid">
      ...
      <div className="run-buttons-card">
        ...
        <div className="run-buttons">
          ...
          <button className="undo-btn" onClick={undoBall}>↩ Undo Last Ball</button>
        </div>
      </div>
        ...
        <div className="over-balls">
          {overBall.slice(-6).map((b, i) => (
            <span
              ...
              key={i}
            >
              {b.isWicket ? "W" : b.extraType === "wide" ? "Wd" : b.extraType === "no-ball" ? "Nb" : b.runsScored}
            </span>
          ))}
        </div>
      </div>
      ...
      <div className="popup-box">
        <div className="popup-card">
          ...
          <select className="select-input"
            onChange={(e) => setWicketData({ ...wicketData, wicketType: e.target.value })}
          >
            <option value="">Select Wicket Type</option>
            {["bowled","caught","lbw","run-out","stumped","hit-wicket","retired-out"].map(type => (
          ...
          >
            ...
            {inningInfo.striker && (
              <option value={inningInfo.striker._id}>{inningInfo.striker.playername}</option>
            )}
            {inningInfo.nonStriker && (
              <option value={inningInfo.nonStriker._id}>{inningInfo.nonStriker.playername}</option>
            )}
          </select>
          ...
          <button className="confirm-btn" onClick={confirmWicket}>Confirm Wicket</button>
        </div>
      </div>
    )}
    ...
    {overDone && (
      <div className="popup-box">
        <div className="popup-card">
          ...
          <button className="confirm-btn" onClick={changeBowler}>Confirm Bowler</button>
        </div>
      </div>
    )}
...
//         <div className="bowler-name">
//           Bowler : {inningInfo.currentBowler?.playername}
//         </div>
//       </div>
...
//         {/* <button className="action-btn" onClick={() => setBowler(true)}>
//           Change Bowler
//         </button> */}
...
//           {/* Out Player - only striker and nonStriker from inningInfo */}
//           <select
//             className="select-input"
//             onChange={(e) =>
...
//           {/* New Batsman - filter players by battingTeam */}
//           <select
//             className="select-input"
//             onChange={(e) =>
...
//       {overDone && (
//   <div className="popup-box">
//     <h3 className="section-title">Over Completed! Select New Bowler</h3>
